...
extension String {
    ...
    func plainTextFromHTML() -> String? {
        do {
            ...
            let stripped = regex.stringByReplacingMatches(in: self, options: .reportProgress, range: NSMakeRange(0, (self as NSString).length), withTemplate: "")
            
            return stripped.stringByDecodingHTMLEntities
        }
        catch {
            return nil
        }
